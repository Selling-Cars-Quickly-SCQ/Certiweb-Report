...
| US06           | Visualización del informe técnico          | T03                  | Crear vista de informe técnico                | Desarrollar la interfaz para mostrar el informe técnico al usuario               | 5                      | Jesus Andres Millones   | To Do      |
|                |                                            | T04                  | Integrar datos del backend                    | Conectar la vista con los datos reales provenientes del backend                  | 4                      | Juan Manuel Santos      | To Do      |
| US07           | Publicación del sello de certificación     | T05                  | Implementar sección de sello de certificación | Crear la sección donde se muestre el sello de certificación en la web            | 4                      | Anghel Melanie Trillo   | To Do      |
|                |                                            | T06                  | Validar visualización del sello               | Asegurar que el sello se muestre correctamente en todos los dispositivos         | 3                      | Franco Mauricio Lopez   | To Do      |
| US08           | Historial de inspecciones                  | T07                  | Crear módulo de historial                     | Desarrollar el módulo para que los usuarios consulten su historial de inspecciones | 5                      | Eric Fabrizio Agama     | Done       |
...
| US09           | Registro masivo de vehículos               | T09                  | Implementar carga masiva                      | Desarrollar la funcionalidad para registrar varios vehículos a la vez            | 6                      | Tony Do Santos          | To Do      |
|                |                                            | T10                  | Validar formato de archivos                   | Implementar validaciones para los archivos de carga masiva                       | 3                      | Anghel Melanie Trillo   | To Do      |
| US010          | Estado de inspecciones                     | T11                  | Crear panel de estado de inspecciones         | Desarrollar un panel donde se muestre el estado de cada inspección               | 5                      | Franco Mauricio Lopez   | To Do      |
|                |                                            | T12                  | Integrar actualizaciones en tiempo real       | Permitir que el estado se actualice automáticamente sin recargar la página       | 4                      | Eric Fabrizio Agama     | To Do      |
| US011          | Enlace compartible para clientes           | T13                  | Generar enlaces compartibles                  | Implementar la generación de enlaces para compartir informes con clientes        | 4                      | Tony Do Santos          | To Do      |
|                |                                            | T14                  | Validar seguridad de los enlaces              | Asegurar que los enlaces sean seguros y sólo accesibles por los destinatarios    | 3                      | Anghel Melanie Trillo   | To Do      |
| US012          | Notificaciones de progreso                 | T15                  | Implementar sistema de notificaciones         | Desarrollar el sistema de notificaciones para informar sobre el progreso         | 5                      | Jesus Andres Millones   | To Do      |
|                |                                            | T16                  | Pruebas de notificaciones                     | Realizar pruebas para asegurar la correcta entrega de notificaciones             | 3                      | Tony Do Santos          | To Do      |
| US013          | Unificación a los estilos de componentes   | T17                  | Revisión y unificación de estilos             | Revisión y unificación de los estilos propuestos previamente para evitar duplicaciones innecesarias dentro del código | 3 | Franco Mauricio Lopez | To Do |
| US014          | Revisión de componentes sin importancia    | T18                  | Eliminar componentes innecesarios             | Revisión de los componentes utilizados y eliminación de archivos CSS o assets sin función importante | 2 | Eric Agama             | To Do |
| US015          | Testeo en diferentes navegadores           | T19                  | Probar en navegadores distintos               | Probar que la página se vea bien en Chrome, Firefox, etc.                        | 2                      | Juan Manuel Santos      | To Do      |
| US016          | Ajustes en carpetas del proyecto           | T20                  | Organizar carpetas del proyecto               | Organizar las carpetas para que el proyecto sea más legible y escalable          | 3                      | Franco Mauricio Lopez   | To Do      |
