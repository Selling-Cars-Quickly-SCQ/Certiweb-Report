...
|---------------------|---------------------|--------------|
| Trabaja en equipo <br> para proporcionar liderazgo en <br> forma conjunta | **Franco Lopez**<br>TB1:<br>Asumí un rol activo dentro del equipo participando en la realización de entrevistas y en la creación de user stories para comprender mejor las necesidades de los usuarios. Además, colaboré en la organización y priorización del Product Backlog para asegurar el desarrollo eficiente del proyecto.<br>TP:<br>Contribuí a nuestro proyecto realizando las correcciones necesarias indicadas por nuestro tutor sobre todo dentro de los segmentos objetivos, además de apoyar en la elaboración de Trello del Sprint 2 para el bienestar del registro ordenado de los mecanismos agregados al trabajo.<br>TB2:<br>Colabore para este entregable en el desarrollo de las entrevistas para los segmentos 3 y 2 como formas de validacion de nuestro producto, ademas de aportar ideas y retroalimentacion para el desarrollo del backend.<br>TF:<br>Apoyé en la creación y realización de entrevistas como metodo de validación de la funcionalidad de nuestra aplicación web, además de aportar observaciones valiosas para el desarrollo del codigo fuente y del informe de entrega final.<br>**Eric Agama**<br>TB1:<br>Formé parte del equipo donde de manera colaborativa participé activamente en la elaboración de Solution Profiles, definición de segmentos objetivo, análisis competitivo y realización de entrevistas. Además, colaboré en el diseño de productos, la arquitectura de software basada en dominio y el desarrollo de landings.<br>TP:<br>Realicé la presentación del Frontend con mejor organización aplicando las mejores prácticas y definiendo los roles de cada uno de los integrantes del equipo a la hora de realizar esta entrega.<br>TB2:<br>Realicé la implementacion de la primera version del backend usando lo practicado en las sesiones de clase, primera compatibilidad del backend con el frontend y despliegue del backend.<br>TF:<br>Realicé la implementacion final del backend con hasheo de contraseñas, WebToken (Tanto para backend y frontend) y la capa de Anti corrupcion. Ademas de verificar la compatibilidad con el backend y fronted y su WebToken.<br>**Jesus Millones**<br>TB1:<br>Contribuí al trabajo en equipo activamente en la realización de entrevistas para obtener información valiosa sobre los usuarios. Además, colaboré en la creación de la Task Matrix y en la definición de las user personas para asegurar que el proyecto cumpliera con las necesidades y expectativas de los usuarios.<br>TP:<br>Apoyé activamente en la generación de ideas y la organización estratégica de tareas en Trello para el desarrollo del Sprint 2. Mi rol fue clave en facilitar discusiones que llevaron a soluciones innovadoras, y asumí la responsabilidad de estructurar las actividades de manera que cada miembro del equipo entendiera su contribución, fomentando así un liderazgo compartido y una ejecución eficiente del proyecto.<br>TB2:<br>[Texto]<br>TF:<br>[Texto]<br>**Juan Santos**<br>TB1:<br>Desempeñé un papel de liderazgo dentro del equipo de trabajo realizando las entrevistas para recopilar información clave de los usuarios. Además, colaboré en la creación del diccionario de clases para garantizar una estructura clara y coherente en el desarrollo del software.<br>TP:<br>Asumí un rol activo en el diseño técnico del sistema, elaborando el diagrama de clases para definir la estructura lógica del software y sus relaciones entre objetos. Asimismo, desarrollé el diagrama de base de datos, asegurando una correcta representación de las entidades, sus atributos y las relaciones necesarias para una gestión eficiente de la información.<br>TB2:<br>Desempeñé un papel activo dentro del equipo, hemos realizado diferentes reportes en base a avances previos que nos han permitido identificar oportunidades de mejora para poder presentar un producto eficiente. Además, establecer las metas y planificar tareas para cumplir con los requisitos solicitados permitio que se lograra la entrega del trabajo.<br>TF:<br>Fomenté un entorno de trabajo colaborativo para completar la etapa final del sistema. Colaboré estrechamente con el equipo para organizar tareas, dar seguimiento a los avances y asegurar una comunicación fluida entre el backend y el frontend. También me aseguré de que todos trabajáramos alineados con los objetivos del proyecto y se cumplieran los plazos establecidos.<br>**Anghel Trillo**<br>TB1:<br>Para la presente entrega desempeñé un rol colaborativo en mi grupo en la realización de entrevistas y en el diseño de software orientado a objetos. Además, colaboré en la gestión de la configuración de software para asegurar la calidad y consistencia del proyecto.<br>TP:<br>Trabajé en equipo efectuando las mejoras continuas recomendadas y aplicando buenas prácticas de programación en el desarrollo de la aplicación.<br>TB2:<br>Desempeñé mejoras continuas en base a los diferentes feedbacks del profesor, tambien colaboré en el apartado de entrevistas de validación para aplicar mejoras continuas con los comentarios de los segmentos objetivo.<br>TF: Mi contribución estuvo centrada en el análisis de observaciones y sugerencias recibidas, lo que permitió ajustar y reforzar distintas áreas del proyecto. Además, me involucré en las entrevistas realizadas para obtener información valiosa que enriqueciera la perspectiva general del trabajo.<br>**Tony Torres**<br>TP:<br>En el presente trabajo, contribuí realizando correcciones y el Trello para tener un registro ordenado de las funciones pensadas en implementarse repartidas entre los diferentes integrantes del equipo. Contribuyendo de esta manera al trabajo en equipo de manera conjunta.<br>TB2:<br>Desempeñé un papel activo dentro de mi grupo al realizar diferentes mejoras continuas en base a los diferentes *feedbacks* y errores que presentaba nuestra propuesta. Colaboré en el apartado de rectificaciones y entrevistas para tener una mejor visión sobre nuestro proyecto.<br>TF:<br>[Texto] | Durante el desarrollo del proyecto Certiweb, el trabajo en equipo y el liderazgo conjunto fueron esenciales para consolidar una visión compartida. La colaboración constante entre todos los miembros permitió tomar decisiones más acertadas, fortalecer la planificación y mantener un enfoque claro en ofrecer una plataforma confiable de inspección técnica de autos usados. Este enfoque colaborativo impulsó una mayor cohesión y permitió al equipo avanzar de manera ágil hacia los objetivos establecidos. |
| Crea un entorno colaborativo e <br> inclusivo, establece <br> metas, planifica tareas y cumple objetivos | **Franco Lopez**<br>TB1:<br>Fomenté un ambiente de trabajo inclusivo y colaborativo. Al establecer metas claras y planificando tareas como la realización de entrevistas para obtener información clave de los usuarios, la creación de user stories para definir las funcionalidades necesarias y la organización del Product Backlog para priorizar las tareas del proyecto.<br>TP:<br>Durante el desarrollo del TP1 logré desarrollar nuevas habilidades de comprensión de entorno digital además de obtener experiencia en el desarrollo comunitario de proyectos web, respetando la asignación de responsabilidades y adecuando tiempos de entrega individuales.<br>TB2:<br> Para el tercer entregable del proyecto final, aprendi acerca del desarrollo web dentro de un backend y la administracion correcta de los datos, ademas de ser fundamental para el desarrollo de nuevas e innovadoras ideas para el sprint 3.<br>TF:<br>En el desarrollo del proyecto final logre aprender sobre metodos de seguridad y autenticación, además del correcto desarrollo de una base de datos y su conectividad a una aplicación, colaborando juntp a mi equipo para el cumplimiento pronto y efectivo de responsabilidades.<br>**Eric Agama**<br>TB1:<br>En base a lo solicitado en la competencia aporté a mi grupo con el desarrollo de un Solution Profile, la definición de segmentos objetivo, el análisis competitivo y la realización de entrevistas para entender mejor las necesidades de los usuarios. Coordiné el diseño del producto, la arquitectura de software basada en dominio y el desarrollo de landings, asegurando que el equipo cumpliera con los objetivos del proyecto de manera eficiente y dentro de los plazos establecidos.<br>TP:<br>Coordiné con el equipo para la entrega de este trabajo que se cumpla con la mejora continua sobre todo, además de asegurarme que la aplicación no tenga errores.<br>TB2:<br>Establecí metas claras para la implementación del backend y planifiqué las tareas de integración con el frontend. Coordiné el desarrollo de la primera versión del backend y su despliegue, asegurando que el equipo mantuviera un enfoque colaborativo durante la implementación de los endpoints y su compatibilidad con la interfaz de usuario.<br>TF:<br>Creé un entorno colaborativo para la implementación final del sistema, estableciendo objetivos específicos para la mejora de la seguridad del backend. Planifiqué y coordiné las tareas de implementación del hasheo de contraseñas, WebTokens y la capa de anti corrupción, mientras aseguré que el frontend integrara correctamente el sistema de autenticación, cumpliendo con todos los objetivos de seguridad establecidos.<br>**Jesus Millones**<br>TB1:<br>Promoví la participación al realizar las entrevistas para comprender mejor las necesidades de los usuarios, la creación de una Task Matrix para organizar las actividades y la definición de user personas para asegurar que el proyecto se alineara con las expectativas de los usuarios.<br>TP:<br>Fui fundamental en la generación colaborativa de ideas para el Sprint 2 y en la organización detallada de tareas en Trello, contribuyendo a la creación de un entorno de trabajo inclusivo donde todas las voces fueron escuchadas. Al establecer metas claras y planificar minuciosamente las tareas, no solo garantizamos que el equipo comprendiera el camino a seguir, sino que también nos mantuvimos enfocados en cumplir los objetivos del sprint de manera efectiva y cohesionada.<br>TB2: En esta etapa del proyecto, desarrollamos diversos informes que nos ayudaron a detectar aspectos perfectibles a partir de los progresos previos. Esta dinámica fue clave para elevar la calidad de nuestra propuesta final. Destaco que una adecuada organización de objetivos y tareas fue esencial para garantizar el cumplimiento de los lineamientos planteados en el encargo académico.<br>TF:<br>[Texto]<br>**Juan Santos**<br>TB1:<br>Generé un clima de colaboración e inclusión dentro del equipo; adicionalmente, realicé entrevistas para recoger información de los usuarios y la creación del diccionario de clases para asegurar una estructura coherente en el proyecto.<br>TP:<br>Asumí un rol activo en el diseño técnico del sistema, elaborando el diagrama de clases para definir la estructura lógica del software y sus relaciones entre objetos. Asimismo, desarrollé el diagrama de base de datos, asegurando una correcta representación de las entidades, sus atributos y las relaciones necesarias para una gestión eficiente de la información.<br>TB2:<br>Desempeñé un papel activo dentro del equipo, hemos realizado diferentes reportes en base a avances previos que nos han permitido identificar oportunidades de mejora para poder presentar un producto eficiente. Además, establecer las metas y planificar tareas para cumplir con los requisitos solicitados permitio que se lograra la entrega del trabajo.<br>TF:<br>Fomenté un entorno de trabajo colaborativo para completar la etapa final del sistema. Colaboré estrechamente con el equipo para organizar tareas, dar seguimiento a los avances y asegurar una comunicación fluida entre el backend y el frontend. También me aseguré de que todos trabajáramos alineados con los objetivos del proyecto y se cumplieran los plazos establecidos.<br>**Anghel Trillo**<br>TB1:<br>Promoví un espacio de trabajo inclusivo y participativo. Para el desarrollo del trabajo identifiqué las necesidades de los usuarios mediante entrevistas, también realicé el diseño de software orientado a objetos y la gestión de configuración de software. Aseguré que cada actividad se completara de acuerdo con los objetivos establecidos, cumpliendo con los plazos y manteniendo la calidad del proyecto.<br>TP:<br>Creé un entorno colaborativo a través de la integración y despliegue continuo de la aplicación, así como la planificación de tareas de las mejoras continuas recomendadas, lo que me permitió cumplir con los objetivos del sprint.<br>TB2:<br>Desempeñé un papel activo dentro del equipo, hemos realizado diferentes reportes en base a avances previos que nos han permitido identificar oportunidades de mejora para poder presentar un producto eficiente. Además, establecer las metas y planificar tareas para cumplir con los requisitos solicitados permitio que se lograra la entrega del trabajo.<br>TF:<br>Fomente un entorno colaborativo para el desarrollo del proyecto, estableciendo objetivos específicos para la mejoras de backend y frontend. También, planifiqué y coordiné las tareas para la mejora de heurísticas del frontend establecidos.<br>**Tony Torres**<br>TP:<br>Me encargué de crear un entorno colaborativo en donde planificamos y establecimos posibles metas futuras impartidas entre los diferentes integrantes del grupo, asignándonos futuras funciones y/o mejoras y correcciones de interfaz mediante Trello.<br>TB2:<br>Para la presente entrega, junto a mi equipo de trabajo hemos realizado diferentes reportes en base a avances previos que nos han permitido identificar oportunidades de mejora para poder presentar un producto pulido y bien logrado. Enfatizo en que fue de vital importancia establecer las metas y planificar tareas para cumplir con los requisitos solicitados en el enunciado del trabajo.<br>TF:<br>[Texto] | En el proyecto Certiweb, crear un entorno colaborativo e inclusivo, acompañado de una planificación estratégica y la definición de metas claras, fue clave para alcanzar cada hito del proceso. La participación activa de cada miembro, la alineación de esfuerzos y el cumplimiento de los objetivos establecidos aseguraron un avance ordenado y sostenible del proyecto. Esta dinámica fortaleció la innovación, la confianza y el compromiso, elementos esenciales para consolidar Certiweb como una propuesta de valor sólida en el mercado. |
...
|-----------------------------------------------------------------------|----------|-----------|----------------------------------------------------------------|---------------------------------------------------------------|-------------------|
| [Certiweb-Landing](https://github.com/Selling-Cars-Quickly-SCQ/Landing-Page) | main  | c042919 | docs(assets): add certiweb and logo picture | docs(assets): add certiweb and logo picture | 26/04/2025 |
| [Certiweb-Landing](https://github.com/Selling-Cars-Quickly-SCQ/Landing-Page) | main  | 727eb97  | docs(video): add certiweb video promo  | docs(video): add certiweb video promo | 26/04/2025 |
| [Certiweb-Landing](https://github.com/Selling-Cars-Quickly-SCQ/Landing-Page) | main  | 5dceb27  | feat(landing): add hero section | feat(landing): add hero section | 26/04/2025 |
| [Certiweb-Landing](https://github.com/Selling-Cars-Quickly-SCQ/Landing-Page) | main  | 49b9560  | feat(landing): add reviews section | feat(landing): add reviews section | 26/04/2025 |
| [Certiweb-Landing](https://github.com/Selling-Cars-Quickly-SCQ/Landing-Page) | main  | 8fd4024  | feat(landing): add contact and footer section | feat(landing): add contact and footer section | 26/04/2025 |
...
| **User Story** | **Title**                                  | **Work-Item / Task** | **Title**                                     | **Description**                                                                 | **Estimation (Hours)** | **Assigned To**         | **Status** |
|----------------|--------------------------------------------|----------------------|-----------------------------------------------|---------------------------------------------------------------------------------|------------------------|-------------------------|------------|
| US05           | Solicitud de inspección                    | T01                  | Implementar formulario de solicitud           | Crear e integrar el formulario para que los usuarios soliciten una inspección    | 6                      | Eric Fabrizio Agama     | Done       |
|                |                                            | T02                  | Validar datos del formulario                  | Implementar validaciones para los campos del formulario de solicitud             | 3                      | Franco Mauricio Lopez   | Done       |
| US06           | Visualización del informe técnico          | T03                  | Crear vista de informe técnico                | Desarrollar la interfaz para mostrar el informe técnico al usuario               | 5                      | Jesus Andres Millones   | Done      |
|                |                                            | T04                  | Integrar datos del backend                    | Conectar la vista con los datos reales provenientes del backend                  | 4                      | Juan Manuel Santos      | Done      |
| US08           | Historial de inspecciones                  | T05                  | Crear módulo de historial                     | Desarrollar el módulo para que los usuarios consulten su historial de inspecciones | 5                      | Eric Fabrizio Agama     | Done       |
|                |                                            | T06                  | Pruebas de usabilidad del historial           | Realizar pruebas para asegurar la facilidad de uso del historial                 | 3                      | Juan Manuel Santos      | Done       |
| US09           | Registro masivo de vehículos               | T07                  | Implementar carga masiva                      | Desarrollar la funcionalidad para registrar varios vehículos a la vez            | 6                      | Tony Do Santos          | Done      |
|                |                                            | T08                  | Validar formato de archivos                   | Implementar validaciones para los archivos de carga masiva                       | 3                      | Anghel Melanie Trillo   | Done      |
| US010          | Estado de inspecciones                     | T09                  | Crear panel de estado de inspecciones         | Desarrollar un panel donde se muestre el estado de cada inspección               | 5                      | Franco Mauricio Lopez   | Done      |
|                |                                            | T10                  | Integrar actualizaciones en tiempo real       | Permitir que el estado se actualice automáticamente sin recargar la página       | 4                      | Eric Fabrizio Agama     | Done      |
| US013          | Unificación a los estilos de componentes   | T11                  | Revisión y unificación de estilos             | Revisión y unificación de los estilos propuestos previamente para evitar duplicaciones innecesarias dentro del código | 3 | Franco Mauricio Lopez | Done |
| US014          | Revisión de componentes sin importancia    | T12                  | Eliminar componentes innecesarios             | Revisión de los componentes utilizados y eliminación de archivos CSS o assets sin función importante | 2 | Eric Agama             | Done |
| US015          | Testeo en diferentes navegadores           | T13                  | Probar en navegadores distintos               | Probar que la página se vea bien en Chrome, Firefox, etc.                        | 2                      | Juan Manuel Santos      | Done      |
| US016          | Ajustes en carpetas del proyecto           | T14                  | Organizar carpetas del proyecto               | Organizar las carpetas para que el proyecto sea más legible y escalable          | 3                      | Franco Mauricio Lopez   | Done      |
| **ENG01**      | **Configuración de base de datos**         | **T15**              | **Configurar esquema de base de datos**       | **Crear y configurar el esquema de base de datos para almacenar información de inspecciones** | **6**                  | **Eric Fabrizio Agama** | **Done**   |
|                |                                            | **T16**              | **Implementar migraciones de datos**          | **Crear scripts de migración para mantener la integridad de los datos**          | **4**                  | **Franco Mauricio Lopez** | **Done** |
...
- Video TB1: [Video](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202213358_upc_edu_pe/EWgaO4I4O3xEmiW0x1jrqosB7ILXKHeAhh9BHs4xYwDgoA?e=Xhm1Ct&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)
