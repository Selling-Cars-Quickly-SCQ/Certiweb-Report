    ...
    <ul style="list-style-type: none; padding-left: 20px;">
      ...
      <li><strong>📊 Características demográficas:</strong>
        <ul style="list-style-type: circle; color: #7f8c8d;">
          ...
          <li>NSE: Educación técnica o universitaria incompleta/completa
    ...
    <ul style="list-style-type: none; padding-left: 20px;">
      ...
      <li><strong>📊 Características demográficas:</strong>
        <ul style="list-style-type: circle; color: #7f8c8d;">
          ...
          <li>Género: Mayoritariamente hombres</li>
          <li>Ubicación: Capitales de región</li>
          <li>Nivel educativo: Secundaria completa, algunos con estudios técnicos o universitarios</li>
          <li>Perfil empresarial: Pequeños emprendedores, negocios familiares, agentes informales o con registro RUC</li>
          <li>Ingresos mensuales: S/. 5,000 – S/. 20,000</li>
          <li>Infraestructura: Taller pequeño, local de exhibición, o venta en espacios compartidos</li>    
        </ul>
      </li>
      <!-- Comportamiento -->
      <li><strong>🔄 Comportamiento y necesidades:</strong>
    ...
    <ul style="list-style-type: none; padding-left: 20px;">
      ...
      <li><strong>📊 Características demográficas:</strong>
        <ul style="list-style-type: circle; color: #7f8c8d;">
          ...
          <li>Género: Hombres y mujeres por igual</li>
          <li>Ubicación: Lima (60%) y regiones como Arequipa, Trujillo, Piura, Cusco, Chiclayo</li>
